...
![](./images/redis-bind-and-port-1632123451620.png)

配置底层有多少个数据库。

![](./images/redis-databases-1632123451621.png)

配置Redis的持久化机制 - RDB。

![](./images/redis-rdb-1-1632123451621.png)

![](images/redis-rdb-3-1632123451621.png)

配置Redis的持久化机制 - AOF。

![](./images/redis-aof-1632123451621.png)

配置访问Redis服务器的验证口令。

![](./images/redis-security-1632123451622.png)

配置Redis的主从复制，通过主从复制可以实现读写分离。

![](./images/redis-replication-1632123451622.png)

配置慢查询。

![](./images/redis-slow-logs-1632123451622.png)
...
![](./images/redis-data-types-1632123451622.png)
